...
namespace Blazor.Web.Controller
{
    //[Route("api/[controller]")]
    [Route("api/[controller]/{action}/{id?}")]
    [ApiController]
    public class SSRSReportController : ControllerBase, IReportController
    {
        ...
        public SSRSReportController(IMemoryCache memoryCache, IWebHostEnvironment hostingEnvironment)
        {
            _cache = memoryCache;
